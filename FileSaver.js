...
function sendData() {
			alert("Starting");
				...
				var content = "<activity><name>" + name +"</name><time_strt>" + time_strt + "</time_strt><time_end>" + time_end + "</time_end><desc>" + desc + "</desc><mon>" + days[0] + "</mon><tue>" + days[1] + "</tue><wed>" + days[2] + "</wed><thur>" + days[3] + "</thur><fri>" + days[4] + "</fri><sat>" + days[5] + "</sat><sun>" + days[6] + "</sun><reqkit>" + kit + "</reqkit></activity>";
				alert(content);
				
				var blob = new Blob([content], {type: "text/xml;charset=utf-8"});
				blob.saveAs(blob, name + ".xml");
			}
